...
```json
{
  "job_id": "abc-123",
  "chunk_id": "chunk-4",
  "chunk_text": "El notario D. Francisco Pérez autorizó la escritura...",
  "entities": [
    {"text": "Francisco Pérez", "label": "PERSON", "confidence": 0.92},
...
[
  {
    ...
    "inferences": [
      {
        "text": "Francisco Pérez autorizó escritura de compraventa por 450.000€",
        "confidence": 0.91,
        "entities": ["Francisco Pérez", "450.000€"]
      }
    ]
  }
]
