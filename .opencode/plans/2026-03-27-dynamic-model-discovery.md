...
**Files:**
- Modify: `/home/hp/Proyectos/local-vllm/.env`
...
```bash
cat /home/hp/Proyectos/local-vllm/.env | grep -A 2 "VLLM_MAX_MODEL_LEN_2B\|VLLM_GPU_MEMORY_UTILIZATION_2B"
```
...
```bash
git add /home/hp/Proyectos/local-vllm/.env
...
```bash
cd /home/hp/Proyectos/local-vllm
...
```bash
cd /home/hp/Proyectos/ia-text-ochestrator
tools/client/client -i /home/hp/tmp/AASD_servodrivemanual.pdf \
