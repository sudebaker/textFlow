...
Run: `tail -20 /path/to/textflow/.env`
...
Run: `tail -20 /path/to/textflow/.env.example`
...
Run: `sed -n '385,406p' /path/to/textflow/deploy/docker/docker-compose.yml`
...
Run: `cd /path/to/textflow/tools/client && go build -o client . && echo "Build OK"`
...
Run: `cd /path/to/textflow && docker compose -f deploy/docker/docker-compose.yml build inference-worker`
...
Run: `cd /path/to/textflow && docker compose -f deploy/docker/docker-compose.yml up -d inference-worker`
...
Run: `cd /path/to/textflow/tools/client && go build -o client .`
...
Run: 
```bash
cd /path/to/textflow/tools/client
