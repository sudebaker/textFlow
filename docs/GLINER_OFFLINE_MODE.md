...
- `/home/amphora/Proyectos/ocugraphrag/glinear_ner_service/main.py` — Correct loading pattern
- `/home/amphora/Proyectos/ocugraphrag/fix_glinear_airgap.sh` — Symlink/cache management script
- `/home/amphora/Proyectos/ocugraphrag/docs/TROUBLESHOOTING.md` — Original source of this solution
