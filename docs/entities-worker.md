...
| "María Pilar" + "María Pilar Rodríguez" | Mergeadas a 1 ❌ | Ambas guardadas ✅ |
...
3. [PER   ] María Pilar                         (0.68)
4. [PER   ] María Pilar Rodríguez Fernández     (0.75)
5. [ORG   ] Fiscal General del Estado           (0.82)
6. [PER   ] García Ortiz                        (0.88)
...
### 4.1 Documento: sentencia-fiscal-garcia-ortiz.pdf (296 chunks)
...
| "María Pilar Rodríguez Fernández" | 002, 003, 004 | Dedup colapsa 3 variaciones a 1 | Dedup exact-match preserva variaciones | Contar María Pilar antes/después |
